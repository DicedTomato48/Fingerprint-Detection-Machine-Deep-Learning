...
if __name__ == '__main__':
    ground_truth_images = r'data2\test_div\1 hand per image hand whole'
    ground_truth_images = os.path.join(os.getcwd(), ground_truth_images)

    ground_truth_labels = r'data2\test_div\labels_2'
    ground_truth_labels = os.path.join(os.getcwd(), ground_truth_labels)

    ground_truth_json_file = r'data2\test_div\Jsons/ground_truth_json_file_div2.json'
    yolo_folders_to_coco_json(ground_truth_images, ground_truth_labels, ground_truth_json_file)

    predicted_labels_yolov10_n = r'data2\test_div\predicted_2/labels_yolov10_N'
    predicted_json_file_yolov10_n = r'data2\test_div\Jsons\div_2/predicted_json_file_yolov10_n.json'
    ...
    predicted_labels_yolov10_m = r'data2\test_div\predicted_2/labels_yolov10_M'
    predicted_json_file_yolov10_m = r'data2\test_div\Jsons\div_2/predicted_json_file_yolov10_m.json'
    ...
    predicted_labels_yolov10_s = r'data2\test_div\predicted_2/labels_yolov10_S'
    predicted_json_file_yolov10_s = r'data2\test_div\Jsons\div_2/predicted_json_file_yolov10_s.json'
    ...
    predicted_labels_yolov10_x = r'data2\test_div\predicted_2/labels_yolov10_X'
    predicted_json_file_yolov10_x = r'data2\test_div\Jsons\div_2/predicted_json_file_yolov10_x.json'
    ...
    predicted_labels_rtdetr = r'data2\test_div\predicted_2/labels_RTDETR'
    predicted_json_file_rtdetr = r'data2\test_div\Jsons\div_2/predicted_json_file_rtdetr.json'
    ...
    predicted_labels_retinanet = r'data2\test_div\predicted_2/labels_RetinaNet'
    predicted_json_file_retinanet = r'data2\test_div\Jsons\div_2/predicted_json_file_retinanet.json'
    ...
    predicted_labels_efficientdet = r'data2\test_div\predicted_2/labels_EfficientDet'
    predicted_json_file_efficientdet = r'data2\test_div\Jsons\div_2/predicted_json_file_efficientdet.json'
    ...
    predicted_labels_yolov11_n = r'data2\test_div\predicted_2/labels_yolov11_N'
    predicted_json_file_yolov11_n = r'data2\test_div\Jsons\div_2/predicted_json_file_yolov11_n.json'
    ...
    predicted_labels_yolov11_s = r'data2\test_div\predicted_2/labels_yolov11_S'
    predicted_json_file_yolov11_s = r'data2\test_div\Jsons\div_2/predicted_json_file_yolov11_s.json'
    ...
    predicted_labels_yolov11_m = r'data2\test_div\predicted_2/labels_yolov11_M'
    predicted_json_file_yolov11_m = r'data2\test_div\Jsons\div_2/predicted_json_file_yolov11_m.json'
    ...
    predicted_labels_yolov11_l = r'data2\test_div\predicted_2/labels_yolov11_L'
    predicted_json_file_yolov11_l = r'data2\test_div\Jsons\div_2/predicted_json_file_yolov11_l.json'
    ...
    predicted_labels_yolov11_x = r'data2\test_div\predicted_2/labels_yolov11_X'
    predicted_json_file_yolov11_x = r'data2\test_div\Jsons\div_2/predicted_json_file_yolov11_x.json'
    ...
    predicted_labels_combine = r'data2\test_div\predicted_2/labels_combine'
    predicted_json_file_combine = r'data2\test_div\Jsons\div_2/predicted_json_file_combine.json'
    predicted_labels = os.path.join(os.getcwd(), predicted_labels_combine)
    yolo_folders_to_coco_json(ground_truth_images, predicted_labels, predicted_json_file_combine)
    ...
    csvfile=open('Result_Tables/table_1hand_perimage_whole.csv', 'w', newline='')
    ...
    coco_eval.summarize()
    print("#############################################################################")
    print("Evaluation result of Combined Methodl")
    print(coco_eval.stats)
    list_re = coco_eval.stats
    model_name = "Combined Method"
    re_arr = []
    re_arr.append(model_name)
    for item in list_re:
        re_arr.append(str(item))
