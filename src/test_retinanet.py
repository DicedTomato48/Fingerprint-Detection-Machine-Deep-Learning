...
def detect_image(image_path, model_path, class_list):
    ...
    for img_name in os.listdir(image_path):
        ...
        with torch.no_grad():
            ...
            imh,imw,_=image_orig.shape
            save_result_folder = r'data2/predicted/labels_RetinaNet'
            ...
            for j in range(0, len(indices)):
                ...
                sw = w / imw
                sh = h / imh
                cv2.putText(image_orig, label + ":" + str(conf), (x, y - 20), cv2.FONT_HERSHEY_SIMPLEX, 1,
                            (0, 255, 255), 2, cv2.LINE_AA)
                cv2.rectangle(image_orig, (x, y), (x + w, y + h), (255, 255, 0), 2)
...
if __name__ == '__main__':
    ...
    imgpath=r'data2/images'
    modelpath=r'retinanet.pt'
    classpath=r'cls.csv'
    detect_image(imgpath, modelpath, classpath)
