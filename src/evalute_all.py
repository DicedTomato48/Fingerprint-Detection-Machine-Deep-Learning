...
if __name__ == '__main__':
    ...
    predicted_labels_centernet = 'data2/predicted/labels_CenterNet'
    predicted_json_file_centernet = 'data2/Jsons/predicted_json_file_centernet.json'
    predicted_labels = os.path.join(os.getcwd(), predicted_labels_centernet)
    yolo_folders_to_coco_json(ground_truth_images, predicted_labels, predicted_json_file_centernet)
    ...
    print(coco_eval.stats)
    print("#############################################################################")
    coco_pre_centernet = COCO(predicted_json_file_centernet)
    # Perform the evaluation
    coco_eval = COCOeval(coco_gt, coco_pre_centernet, 'bbox')
    coco_eval.evaluate()
    coco_eval.accumulate()
    coco_eval.summarize()
    print("#############################################################################")
    print("Evaluation esult of CenterNet model")
    print(coco_eval.stats)
    print("#############################################################################")
