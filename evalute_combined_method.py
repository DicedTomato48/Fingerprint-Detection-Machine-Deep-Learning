...
if __name__ == '__main__':
    ground_truth_images = 'data/images'
    ...
    predicted_labels = 'data/predicted/labels_combine'
    predicted_labels = os.path.join(os.getcwd(), predicted_labels)

    ground_truth_json_file = 'data/Jsons/ground_truth_json_file.json'
    yolo_folders_to_coco_json(ground_truth_images, ground_truth_labels, ground_truth_json_file)
    predicted_json_file = 'data/Jsons/predicted_json_file_combine.json'
